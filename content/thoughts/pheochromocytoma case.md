...
### Investigation Rooms:
1. **The Laboratory** - Where biochemical secrets are revealed (elevated plasma metanephrines, anyone?)
2. **The Radiology Chamber** - Home of imaging clues (those CT scans showing a 3.2 cm right adrenal mass)
3. **The Patient Encounter Room** - Where symptoms tell their tales (episodic symptoms including headache, palpitations, and diaphoresis)
4. **The Research Facility** - Repository of epidemiology and etiology (genetic associations like MEN2 and VHL syndromes)
5. **The Pathology Department** - Where microscopic evidence lies (chromaffin cells with “zellballen” pattern)
...
1. **Transformed passive learning into active problem-solving**
   Students became investigators rather than note-takers

2. **Created emotional investment in the outcome**
   Teams competed to gather evidence and make the diagnosis first

3. **Made clinical pearls memorable through narrative**
   “Remember when giving beta-blockers first nearly killed our suspect?” is more memorable than “Alpha blockade must precede beta blockade”

4. **Demonstrated clinical reasoning as a process**
   Students could visualize how evidence collection leads to diagnostic refinement

5. **Built confidence through guided discovery**
   Teams felt the thrill of solving the case themselves, with faculty as guides rather than lecturers
...
1. **Play is a powerful teacher**
   Game mechanics tap into intrinsic motivation in ways traditional methods can’t

2. **Narratives stick better than facts**
   Students remember stories and characters long after they forget bullet points

3. **Visualization matters for abstract concepts**
   Creating physical or digital representations of reasoning processes makes them more accessible

4. **Emotional engagement enhances retention**
   The excitement, competition, and satisfaction of game-based learning creates stronger memory formation

5. **Student agency improves outcomes**
   Giving learners active roles in the diagnostic process builds both confidence and competence
